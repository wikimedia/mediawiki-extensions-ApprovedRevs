...
$messages['fa'] = array(
	...
	'approvedrevs-logname' => 'سیاههٔ تأیید نسخه',
	'approvedrevs-logdesc' => 'این سیاههٔ نسخه‌هایی است که تأیید شده‌اند.',
...
در عوض، یک صفحهٔ خالی نشان‌داده خواهد شد.',
	...
	'approvedrevs-blankpageshown' => 'هیچ نسخه‌ای از این صفحه تأیید نشده‌اند.',
	'approvedrevs-noapprovedrevision' => 'این آخرین نسخهٔ این صفحه است؛ نسخهٔ تأییدشده‌ای ندارد.',
	'approvedrevs-editwarning' => 'توجه‌کنید که شما در حال ویرایش آخرین نسخهٔ این صفحه هستید که با نسخهٔ تأیید شده‌ای که به صورت پیش‌فرض نمایش می‌شود تفاوت دارد.',
	'approvedrevs' => 'نسخه‌های تأییدشده',
	'approvedrevs-approvedpages' => 'تمام صفحات دارای نسخهٔ تأییدشده',
	'approvedrevs-notlatestpages' => 'صفحاتی که نسخهٔ تأییدشدهٔ آن‌ها آخرین نیست',
	'approvedrevs-unapprovedpages' => 'صفحه‌های تاییدنشده',
	'approvedrevs-view' => 'مشاهده:',
	'approvedrevs-revisionnumber' => 'نسخهٔ $1',
	'approvedrevs-approvedby' => 'تأیید شده توسط {{GENDER:$3|$1}} در تاریخ $4 در ساعت $5',
	'approvedrevs-difffromlatest' => 'تفاوت با آخرین',
	'approvedrevs-approvelatest' => 'تأیید آخرین',
	'approvedrevs-approvethisrev' => 'این نسخه را تأیید کنید.',
...
Sellaisen sijaan esitetään tyhjä sivu.',
	...
	'approvedrevs-noapprovedrevision' => 'Tämä on sivun viimeisin versio. Hyväksyttyä versiota ei ole.',
...
대신에 빈 문서가 보입니다.',
	...
	'approvedrevs-editwarning' => '현재 편집하고 있는 문서는 이 문서의 최신 판이며, 기본으로 보이는 승인된 판과는 다름에 주의하세요.',
	'approvedrevs' => '승인한 판',
...
Doför kritt mer en läddije Sigg aanjezeish.',
	...
	'approvedrevs-noapprovedrevision' => 'Dat heh es de neuste Väsjohn vun dä Sigg. Se hät kein joodjeheiße Väsjohne.',
	'approvedrevs-editwarning' => 'Opjepaß: Do bes de neuste Version vun heh dä Sigg aam ändere. Dat es nit de joodjeheiße Väsjohn, di mer schtandmääßesch aanjezeisch kritt.',
 ...
 */
$messages['mk'] = array(
	'approvedrevs-desc' => 'Поставање на една единствена преработка на страницата како одобрена',
	'approvedrevs-logname' => 'Дневник на одобрени преработки',
	'approvedrevs-logdesc' => 'Ова е дневникот на одобрени преработки.',
	'approvedrevs-approve' => 'одобри',
	'approvedrevs-unapprove' => 'неодобрена',
	'approvedrevs-approvesuccess' => 'Оваа преработка на страницата е поставена како одобрена.',
...
Наместо тоа ќе се прикажува празна страница.',
	...
	'approvedrevs-notlatest' => 'Ова е одобрената преработка на страницава, но не е најновата.',
	'approvedrevs-approvedandlatest' => 'Ова е одобрената преработка на страницава, а воедно и најновата.',
	'approvedrevs-blankpageshown' => 'Нема одобрена преработка за страницава.',
	'approvedrevs-noapprovedrevision' => 'Ова е најнова преработка на страницата; нема одобрена преработка.',
	...
	'approvedrevs' => 'Одобрени преработки',
	'approvedrevs-approvedpages' => 'Сите страници со одобрена преработка',
	'approvedrevs-notlatestpages' => 'Страници чиишто одобрени преработки не се најновите',
	'approvedrevs-unapprovedpages' => 'Неодобрени страници',
	'approvedrevs-view' => 'Преглед:',
	'approvedrevs-revisionnumber' => 'преработка $1',
	...
	'approvedrevs-viewlatestrev' => 'Најнова преработка.',
	'right-approverevisions' => 'Поставување на извесна преработка на викистраница како одобрена',
...
Het is niet de meeste recente versie.',
	...
	'approvedrevs-approvedby' => 'goedgekeurd door {{GENDER:$3|$1}} op $4 om $5',
...
$messages['zh-hans'] = array(
	'approvedrevs-desc' => '设定单个页面版本为已认可',
	'approvedrevs-logname' => '版本认可日志',
	'approvedrevs-logdesc' => '这是已经被认可的版本的日志。',
	'approvedrevs-approve' => '认可',
	'approvedrevs-unapprove' => '不认可',
	'approvedrevs-approvesuccess' => '本页面的该版本已经被设为已认可版本。',
...
相反，将显示一个空白页。',
	...
	'approvedrevs-notlatestpages' => '已认可版本不是最后版本的页面',
	'approvedrevs-unapprovedpages' => '未认可页面',
	'approvedrevs-view' => '查看：',
	'approvedrevs-revisionnumber' => '版本$1',
	'approvedrevs-approvedby' => '被{{GENDER:$3|$1}}于$4 $5认可',
	'approvedrevs-difffromlatest' => '与最后版本的差异',
	'approvedrevs-approvelatest' => '认可最后版本',
	'approvedrevs-approvethisrev' => '认可该版本。',
	'approvedrevs-viewlatestrev' => '查看最后版本',
